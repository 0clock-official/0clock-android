...
import com.xyz.oclock.databinding.FragmentUploadStdCardBinding
import com.xyz.oclock.ui.signup.SignUpFragmentDirections
import com.xyz.oclock.ui.signup.stdcard.SignUpStdCardFragment

class UploadStdCardFragment: BindingFragment<FragmentUploadStdCardBinding>(R.layout.fragment_upload_std_card)  {

    private val viewModel: UploadStdCardViewModel by viewModels()
    ...
    private fun setListener() {
        binding.uploadStdCardLayout.onThrottleClick {
            takePhoto()
        }
        binding.uploadStdCardNext.onThrottleClick {
            viewModel.uploadStdCard {
                moveToPendingFragment()
            }
        }
    }

    private fun moveToPendingFragment() {
        val action = UploadStdCardFragmentDirections.actionUploadStdCardFragmentToPendingFragment()
    ...
    private fun showImagePickerDialog() {
        PickImageDialog
            .build(
                ...
                if (it.error == null) {
                    binding.uploadStdCardImageview.setImageBitmap(it.bitmap)
    ...
    companion object {
        val TAG: String = UploadStdCardFragment::class.java.simpleName
